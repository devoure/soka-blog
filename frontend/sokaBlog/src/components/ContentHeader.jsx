  ...
  return (
    <div className="w-full h-[80%] min-h-[490px] min-w-[375px] flex items-center justify-start pl-5">
      <div className="w-[300px] h-[300px] z-10 tablet:w-[450px] laptop:w-[500px] xl:w-[550px] laptop:h-[350px] bg-transparent top-[10%] relative flex-none">
        ...
        <div className="bg-white h-[180px] w-[180px] absolute z-[-1] tablet:h-[250px] tablet:w-[250px] xl:w-[300px] xl:h-[300px] -right-5 -bottom-11 tablet:-right-[30%] laptop:-right-[32%] laptop:bottom-0 xl:-right-[40%] rounded-full overflow-hidden object-center object-cover">
        <img src={ profpic } />
      </div>
      </div>
    </div>
